...
savedir = Path(__file__).parent.parent / 'representational_drift'
kind = 'gray'
day0 = np.load(savedir / f'day0_{kind}.npy')
day5 = np.load(savedir / f'day5_{kind}.npy')
...
ax.set_xlabel(r'$\Delta$ trial')
ax.set_ylabel('correlation')
ax.spines['right'].set_visible(False)
ax.spines['top'].set_visible(False)
fig.tight_layout(pad=0.7)
plt.show()
fig.savefig(f'figures/drift_{kind}.eps')
