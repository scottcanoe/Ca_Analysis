...
# ABCD_0 = ABCD_0.isel(time=slice(32, None))
# ABBD_0 = ABBD_0.isel(time=slice(32, None))
# ACBD_0 = ACBD_0.isel(time=slice(32, None))
# ABCD_5 = ABCD_5.isel(time=slice(32, None))
# ABBD_5 = ABBD_5.isel(time=slice(32, None))
# ACBD_5 = ACBD_5.isel(time=slice(32, None))
...
fig.savefig('figures/summary_heatmaps_gray.png', dpi=600)
fig.savefig('figures/summary_heatmaps_gray.eps', dpi=600)
