...
def open_session(
    ...
    s.reg.add("mov_unprocessed", "scratch/mov_unprocessed.h5?key=data"),
...
class Transition:
    ...
    def _parse(self, extract: str = "spikes") -> None:
        """
        ...
        # Extract chunks
        mat = getattr(s.cells, "spikes").data
